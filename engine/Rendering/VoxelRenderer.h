...
struct RenderedChunk {
    ...
    GLuint VBO_lightmapUV;     // Vertex Buffer Object for lightmap coordinates
...
private:
    ...
    GLint m_uniformLightmap;
    
    // Default textures
    Texture m_dirtTexture;
    GLuint m_defaultLightmap;  // White texture for when lightmaps aren't ready
